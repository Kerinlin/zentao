...
| 4002 | 当前工作区未设置产品/项目/执行范围，请先 `workspace set/add --product=…` 或显式传范围参数 |
| 4003 | 无法根据 {kind} #{id} 设置工作区，请检查 ID 是否正确或是否有权限访问 |
| 4004 | 名称匹配到多个工作区，请改用数字 ID |
| 4005 | 无法删除工作区（附具体 reason） |
| **网络通信 (50xx)** | |
